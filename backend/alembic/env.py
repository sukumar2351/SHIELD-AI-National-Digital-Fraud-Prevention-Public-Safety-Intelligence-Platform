...
import os
import sys
# Make sure project directory is in sys.path
sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

from app.config import settings
from app.database import Base
# Make sure models are imported so Alembic discovers tables
...
def run_migrations_online() -> None:
    ...
    """
    # Overwrite connection URL dynamically from config settings
